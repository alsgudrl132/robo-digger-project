...
# set xvlog options
xvlog_opts="--incr --relax  -L smartconnect_v1_0 -L axi_vip_v1_1_19 -L xilinx_vip"
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb soc_digger.wdb xsim.dir libdpi.so)
