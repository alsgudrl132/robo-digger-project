...
/ {
	...
	amba_pl: amba_pl {
		...
		myip_pwm_blade: myip_pwm@44a60000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			...
			xlnx,name = "myip_pwm_blade";
		};
		myip_pwm_left_wheel: myip_pwm@44a40000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-pwm-1.0";
			status = "okay";
			...
			xlnx,name = "myip_pwm_left_wheel";
		};
		myip_pwm_right_wheel: myip_pwm@44a70000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-pwm-1.0";
			status = "okay";
			...
			xlnx,name = "myip_pwm_right_wheel";
		};
		myip_pwm_x1: myip_pwm@44a00000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-pwm-1.0";
			status = "okay";
			...
			xlnx,name = "myip_pwm_x1";
		};
		myip_pwm_x2: myip_pwm@44a20000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-pwm-1.0";
			status = "okay";
			...
			xlnx,name = "myip_pwm_x2";
		};
		myip_pwm_y1: myip_pwm@44a10000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-pwm-1.0";
			status = "okay";
			...
			xlnx,name = "myip_pwm_y1";
		};
		myip_pwm_y2: myip_pwm@44a30000 {
			xlnx,rable = <0>;
			xlnx,s00-axi-data-width = <32>;
			compatible = "xlnx,myip-pwm-1.0";
			status = "okay";
...
/ {
	...
	aliases {
		serial0 = &axi_hc05_uart;
		serial1 = &axi_usb_uart;
	};
	cpus_microblaze_riscv_0: cpus_microblaze_riscv@0 {
		address-map = <0x00000000 &microblaze_riscv_0_local_memory_dlmb_bram_if_cntlr_memory 0x00000000 0x20000>,
			      ...
			      <0x44a00000 &myip_pwm_x1 0x44a00000 0x10000>,
			      <0x44a10000 &myip_pwm_y1 0x44a10000 0x10000>,
			      <0x44a20000 &myip_pwm_x2 0x44a20000 0x10000>,
			      <0x44a30000 &myip_pwm_y2 0x44a30000 0x10000>,
			      <0x44a40000 &myip_pwm_left_wheel 0x44a40000 0x10000>,
			      <0x44a60000 &myip_pwm_blade 0x44a60000 0x10000>,
			      <0x44a70000 &myip_pwm_right_wheel 0x44a70000 0x10000>,
